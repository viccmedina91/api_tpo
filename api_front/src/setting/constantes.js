...
export const SECCIONES = [
    ...
    },
    {
        ...
        subSections: [
            ...
            { nombre: 'Crear Unidad', url: '/unidad/crear' },
            { nombre: 'Unidades por Edificio', url: '/edificio/unidades' },
            { nombre: 'Transferir Unidad', url: '/unidad/transferir' },
            { nombre: 'Crear Edificio', url: '/unidad/crear' },
            { nombre: 'Modificar Edificio', url: '/unidad/modificar' },
